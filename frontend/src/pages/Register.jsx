...
//       {/* Left Side: Login Form (approx 45% width) */}
//       <div className="form-section w-full lg:w-[45%] flex flex-col justify-center items-center p-8 relative">
//         <div className="absolute top-8 left-8 lg:left-12 flex justify-between w-[85%] items-center">
//           <div
//             onClick={() => navigate("/")}
//             className="logo h-8 w-8 bg-orange-600 rounded-full flex items-center justify-center"
//           >
...
//       <div className="visual-section hidden lg:flex flex-1 bg-gradient-to-br from-[#121212] to-[#000000] items-center justify-center p-12 relative">
