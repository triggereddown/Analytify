...
export const Heatmap = ({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(249,115,22,0.12),transparent_24%),linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0))]" />
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          <p className="text-[10px] uppercase tracking-[0.28em] text-orange-200/70">Archive Map</p>
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500">
          ...
          <div className="w-3.5 h-3.5 rounded-sm bg-orange-500 border border-orange-400/50" />
          <span>More</span>
        </div>
      </div>
      ...
      <div className="relative overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
        ...
        {hoveredDay && (
          <div
            className="fixed z-50 pointer-events-none min-w-[160px] rounded-xl border border-orange-400/20 bg-[#0b0f17]/96 p-3 text-[11px] text-white shadow-2xl backdrop-blur-md transition-opacity duration-150"
            style={{
